package com.example.understanding_android_room_java;
...
public class MainActivity extends AppCompatActivity {
    ...
    private WordListViewModel mWordViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordListViewModelFactory factory = InjectorUtils.provideWordListViewModelFactory(getApplicationContext());
        // Get a new or existing ViewModel from the ViewModelProvider.
        mWordViewModel = new ViewModelProvider(this, factory).get(WordListViewModel.class);
